...
if [ "$PLATFORM" == "raspberry_pi" ]; then
    ...
    apt-get update
    apt-get install -y python3-pip python3-numpy python3-scipy python3-matplotlib pigpio python3-pigpio
    ...
    apt-get update
    apt-get install -y python3-pip python3-numpy python3-scipy python3-matplotlib
